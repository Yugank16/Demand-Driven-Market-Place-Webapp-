                ...
                <div className="content">
                    ...
                    <form onSubmit={this.handleSubmit} className="FormFields">
                        ...
                        <div className="FormField">
                            ...
                            <input type="date" value={this.state.birthDate} id="datetime" className="FormField__Input" placeholder="Enter date and time" name="birth_date" onChange={this.handleChange} />
                        </div>
                        <div className="FormField">
                            <label className="FormField__Label" htmlFor="user_type">Gender</label>
                            <select className="FormField__Input" value={this.state.gender} name="gender" onChange={this.handleChange}>
